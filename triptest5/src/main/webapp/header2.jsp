				...
				<div class="container">
					...
					<div class="nino-menuItem pull-right">
						...
						<ul class="nino-iconsGroup nav navbar-nav">
							<li><a href="#" style="font-size: small"><i class="mdi mdi-emoticon-outline nino-icon">마이페이지</i></a></li>
						</ul>
						<ul class="nino-iconsGroup nav navbar-nav">
							<li><a href="#" onclick="location.href='member/logout'" style="font-size: small"><i class="mdi mdi-emoticon-outline nino-icon">로그아웃</i></a></li>
						</ul>
						<ul class="nino-iconsGroup nav navbar-nav">
